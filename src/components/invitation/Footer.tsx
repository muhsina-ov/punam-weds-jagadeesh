  ...
  return (
    <footer className="relative overflow-hidden pt-28 pb-14">
      ...
      <div className="relative z-20 mx-auto max-w-xl px-6 text-center">
        <Ornament />
        <p className="mt-6 font-display text-xs tracking-[0.24em] text-gold-deep font-semibold uppercase">
          {invitation.footer.sacredHeading}
        </p>
        <h2 className="mt-4 font-script text-3xl leading-snug text-primary italic sm:text-4xl">
