    ...
    <section className="relative h-[100svh] min-h-[620px] w-full overflow-hidden">
      ...
      >
        <motion.div
          ...
          className="mb-3 inline-flex items-center gap-2 rounded-full border border-gold/40 bg-cream/70 px-4 py-1 backdrop-blur-xs"
        >
          <span className="font-display text-[0.68rem] tracking-[0.22em] text-gold-deep font-semibold uppercase">
            {invitation.hero.sacredInvocation}
          </span>
        </motion.div>
        ...
        <motion.h1
          ...
          className="mt-6 flex flex-col items-center leading-[1.18] text-primary drop-shadow-[0_2px_18px_rgba(255,255,255,0.55)]"
        >
          <span className="block font-display text-4xl tracking-normal sm:text-5xl md:text-6xl">
            Punam Bhakta
          </span>
          <span className="my-1 block font-display text-4xl tracking-normal sm:text-5xl md:text-6xl">
            &amp;
          </span>
          <span className="block font-display text-4xl tracking-normal sm:text-5xl md:text-6xl">
            Jagdish Shahani
        ...
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1.2, delay: 1.18 }}
          className="mt-2 font-sans text-xs tracking-[0.24em] text-primary/75 uppercase"
        >
          December 22 &amp; 23, 2026 • Humble, Texas
        </motion.p>
